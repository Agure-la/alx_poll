...
/**
 * The main polls page.
 * This page displays a list of all the polls, with options to search and filter them.
 */
export default function PollsPage() {
  ...
  useEffect(() => {
    // When the component mounts, we load all the polls from the API.
  ...
  useEffect(() => {
    ...
    // We filter the polls based on the search term.
    if (searchTerm) {
    ...
    // We filter the polls based on the selected status filter.
    if (filter === "active") {
